...
public class AdminPanelController {
    ...
    public AdminPanelController(UserService userService, UserAdminService userAdminService, ImageService imageService) {
    ...
    @GetMapping("/admin/generuj-miniatury")
    String generateThumbnails() {
        imageService.generateMiniaturesForCurrentPhotos();
        return "redirect:/admin/zdjecia";
    }
}
